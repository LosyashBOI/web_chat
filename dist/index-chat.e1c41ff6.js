...
})({"6n1Yb":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "90467d78e1c41ff6";
...
},{}],"dlSiV":[function(require,module,exports) {
...
var _viewChatJs = require("./view-chat.js");
...
async function sendEmail(event) {
    ...
    const emailAddress = {
        email: _viewChatJs.UI_ELEMENTS.AUTHORIZATION_INPUT.value
    };
    try {
        ...
        else _viewChatJs.openConfirmation();
    } catch (e) {
        alert(e);
    }
...
function getCode() {
    const code = _viewChatJs.UI_ELEMENTS.CONFIRMATION_INPUT.value;
    try {
        if (!!code) {
            _jsCookieDefault.default.set('token', code);
            _viewChatJs.UI_ELEMENTS.CONFIRMATION_INPUT.value = '';
            _viewChatJs.UI_ELEMENTS.MODAL.style.display = 'none';
            _viewChatJs.UI_ELEMENTS.CONFIRMATION_WINDOW.style.display = 'none';
            return code;
...
async function changeUsername() {
    const url = 'https://mighty-cove-31255.herokuapp.com/api/user';
    const newName = {
        name: _viewChatJs.UI_ELEMENTS.USERNAME_INPUT.value
    };
    try {
        await fetch(url, {
            method: 'PATCH',
...
function getOlderMessages() {
    const scroll = _viewChatJs.UI_ELEMENTS.CHAT_OUTPUT;
    const threshold = scroll.scrollHeight + scroll.scrollTop - scroll.offsetHeight < 50;
    let count = 20;
    if (threshold) {
        count *= 2;
        _viewChatJs.showMessageHistory(count);
    }
}
// document.addEventListener('DOMContentLoaded', () => showMessageHistory(20));
_viewChatJs.UI_ELEMENTS.SETTINGS_BUTTON.addEventListener('click', _viewChatJs.openSettings);
_viewChatJs.UI_ELEMENTS.LOG_OUT_BUTTON.addEventListener('click', _viewChatJs.logOut);
_viewChatJs.UI_ELEMENTS.CHAT_SUBMIT.addEventListener('click', _viewChatJs.sendMessage);
_viewChatJs.UI_ELEMENTS.AUTHORIZATION_SUBMIT.addEventListener('click', sendEmail);
_viewChatJs.UI_ELEMENTS.CONFIRMATION_SUBMIT.addEventListener('click', getCode);
_viewChatJs.UI_ELEMENTS.USERNAME_SUBMIT.addEventListener('click', changeUsername);
_viewChatJs.UI_ELEMENTS.USERNAME_SUBMIT.addEventListener('click', getNewUsername);
...
_socket.socket.onmessage = function(event) {
    ...
    const message = _viewChatJs.createMessage(messageData.user.name, messageData.createdAt, 'companion', messageData.text);
    _viewChatJs.UI_ELEMENTS.CHAT_OUTPUT.append(message);
// console.log(message);
};
for (let btn of _viewChatJs.UI_ELEMENTS.CLOSE_WINDOW)btn.addEventListener('click', _viewChatJs.closeWindow);
 // showMessageHistory(20);

},{"./view-chat.js":"34S7K","./storage.js":"kS9sU","js-cookie":"c8bBu","./socket":"duoz3","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"34S7K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _dateFns = require("date-fns");
var _mainChatJs = require("./main-chat.js");
var _storageJs = require("./storage.js");
...
function createMessage(username, time, from, text) {
    ...
    message.lastElementChild.textContent = _mainChatJs.getTime(time);
    return message;
}
...
async function showMessageHistory(visibleMessages) {
    if (isLoading) return;
    isLoading = true;
    const messageHistory = await _mainChatJs.getMessageHistory();
...
},{"date-fns":"9yHCA","./main-chat.js":"dlSiV","./storage.js":"kS9sU","./socket.js":"duoz3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./storage.js":"kS9sU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6n1Yb","dlSiV"], "dlSiV", "parcelRequireaa79")

//# sourceMappingURL=index-chat.e1c41ff6.js.map
