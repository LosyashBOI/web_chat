...
})({"jBEzN":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "70a7185ae60bdde7";
...
},{}],"1avU3":[function(require,module,exports) {
...
var _viewChatikJs = require("./view-chatik.js");
...
async function sendEmail(event) {
    ...
    const emailAddress = {
        email: _viewChatikJs.UI_ELEMENTS.AUTHORIZATION_INPUT.value
    };
    try {
        ...
        else _viewChatikJs.openConfirmation();
    } catch (e) {
        alert(e);
    }
...
function getCode() {
    const code = _viewChatikJs.UI_ELEMENTS.CONFIRMATION_INPUT.value;
    try {
        if (!!code) {
            _jsCookieDefault.default.set('token', code);
            _viewChatikJs.UI_ELEMENTS.CONFIRMATION_INPUT.value = '';
            _viewChatikJs.UI_ELEMENTS.MODAL.style.display = 'none';
            _viewChatikJs.UI_ELEMENTS.CONFIRMATION_WINDOW.style.display = 'none';
            return code;
        } else throw new Error('Введите код');
    } catch (e) {
        alert(e);
    }
}
async function changeUsername() {
    const url = 'https://mighty-cove-31255.herokuapp.com/api/user';
    const newName = {
        name: _viewChatikJs.UI_ELEMENTS.USERNAME_INPUT.value
    };
    try {
        await fetch(url, {
            method: 'PATCH',
...
async function getNewUsername() {
    ...
    try {
        ...
        // console.log(json);
        if (response.ok) {
            _jsCookieDefault.default.set('currentUser', json.name);
            // currentUser = Cookies.get('currentUser');
            console.log(_storageJs.currentUser);
        }
    } catch (e) {
        alert(e);
    }
...
//     Cookies.set('currentUser', user.name);
// });
}
...
function getTime(time) {
    return _dateFns.format(new Date(time), 'HH:mm');
}
function getOlderMessages() {
    const scroll = _viewChatikJs.UI_ELEMENTS.CHAT_OUTPUT;
    const threshold = scroll.scrollHeight + scroll.scrollTop - scroll.offsetHeight < 50;
    let count = 20;
    if (threshold) {
        count *= 2;
        _viewChatikJs.showMessageHistory(count);
    }
}
// document.addEventListener('DOMContentLoaded', () => showMessageHistory(20));
_viewChatikJs.UI_ELEMENTS.SETTINGS_BUTTON.addEventListener('click', _viewChatikJs.openSettings);
_viewChatikJs.UI_ELEMENTS.LOG_OUT_BUTTON.addEventListener('click', _viewChatikJs.logOut);
_viewChatikJs.UI_ELEMENTS.CHAT_SUBMIT.addEventListener('click', _viewChatikJs.sendMessage);
_viewChatikJs.UI_ELEMENTS.AUTHORIZATION_SUBMIT.addEventListener('click', sendEmail);
_viewChatikJs.UI_ELEMENTS.CONFIRMATION_SUBMIT.addEventListener('click', getCode);
_viewChatikJs.UI_ELEMENTS.USERNAME_SUBMIT.addEventListener('click', changeUsername);
_viewChatikJs.UI_ELEMENTS.USERNAME_SUBMIT.addEventListener('click', getNewUsername);
// UI_ELEMENTS.CHAT_SCROLL.addEventListener('scroll', throttle(getOlderMessages, 250));
_socket.socket.onmessage = function(event) {
    const messageData = JSON.parse(event.data);
    const message = _viewChatikJs.createMessage(messageData.user.name, messageData.createdAt, 'companion', messageData.text);
    _viewChatikJs.UI_ELEMENTS.CHAT_OUTPUT.append(message);
// console.log(message);
};
for (let btn of _viewChatikJs.UI_ELEMENTS.CLOSE_WINDOW)btn.addEventListener('click', _viewChatikJs.closeWindow);
 // showMessageHistory(20);

},{"./storage.js":"kS9sU","js-cookie":"c8bBu","./socket":"duoz3","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view-chatik.js":"colaD"}],"kS9sU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const currentUser = _jsCookieDefault.default.get('currentUser');
...
parcelHelpers.export(exports, "sendMessageToServer", ()=>sendMessageToServer
);
var _storageJs = require("./storage.js");
const socket = new WebSocket(`wss://mighty-cove-31255.herokuapp.com/websockets?${_storageJs.token}`);
function sendMessageToServer(textInput) {
...
},{"./storage.js":"kS9sU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"colaD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UI_ELEMENTS", ()=>UI_ELEMENTS
);
parcelHelpers.export(exports, "openSettings", ()=>openSettings
);
parcelHelpers.export(exports, "logOut", ()=>logOut
);
parcelHelpers.export(exports, "openConfirmation", ()=>openConfirmation
);
...
parcelHelpers.export(exports, "showMessageHistory", ()=>showMessageHistory
);
var _dateFns = require("date-fns");
var _mainChatikJs = require("./main-chatik.js");
var _storageJs = require("./storage.js");
...
function createMessage(username, time, from, text) {
    ...
    // const author = message.firstElementChild.firstElementChild;
    //
    // author.textContent = username + ':';
    message.firstElementChild.textContent = username + ': ' + text;
    message.lastElementChild.textContent = _mainChatikJs.getTime(time);
    return message;
}
function sendMessage() {
    if (UI_ELEMENTS.CHAT_INPUT.value) {
        try {
            _socketJs.sendMessageToServer(UI_ELEMENTS.CHAT_INPUT.value);
        } catch (e) {
            alert(e);
        }
...
async function showMessageHistory(visibleMessages) {
    if (isLoading) return;
    isLoading = true;
    const messageHistory = await _mainChatikJs.getMessageHistory();
    ...
    // console.log(messageHistory.messages.length);
    isLoading = false;
}

},{"date-fns":"9yHCA","./main-chatik.js":"1avU3","./storage.js":"kS9sU","./socket.js":"duoz3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jBEzN","1avU3"], "1avU3", "parcelRequireaa79")

//# sourceMappingURL=main-chatik.js.map
